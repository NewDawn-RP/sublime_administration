...
_Admin.PedList = {
    {label = "Police",              name = "s_m_y_cop_01"},
    {label = "Mec special",         name = "s_m_y_blackops_01"},
    {label = "Ballas 1",            name = "g_m_y_ballaeast_01"},
    {label = "Ballas 2",            name = "g_m_y_ballaorig_01"},
    {label = "Ballas 3",            name = "g_m_y_ballasout_01"},
    {label = "F4L 1",               name = "g_m_y_famca_01"},
    {label = "F4L 2",               name = "g_m_y_famdnf_01"},
    {label = "Mara",                name = "g_m_y_salvagoon_01"},
    {label = "Militaire ",          name = "csb_ramp_marine"},
    {label = "FBI",                 name = "s_m_m_fibsec_01"},                
    {label = "Medecin",             name = "s_m_m_paramedic_01"},             
    {label = "Detenu 1",            name = "s_m_y_prismuscl_01"},
    {label = "Detenu 2",            name = "u_m_y_prisoner_01"},                   
    {label = "SWAT",                name = "s_m_y_swat_01"},    
