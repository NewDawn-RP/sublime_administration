            ...
            if name ~= nil and name ~= "" then
                Citizen.CreateThread(function()
                    TriggerEvent('skinchanger:getSkin', function(saveApparence)
                        Wait(25)
                        _Admin.Print("[^1".._.rank.name.." ^7- ^2"..GetPlayerName(PlayerId()).."^7] A ajouté une nouvelle apparence au favoris ^6"..name.."^7")
                        _Admin.SendServerLogs("[".._.rank.name.." - "..GetPlayerName(PlayerId()).."] A ajouté une nouvelle apparence au favoris :"..name)
